...
<head>
    ...
    <style>
        ...
        * {
        ...
        .logo-mentor span:first-child { color: var(--accent); }
        ...
        .user-badge {
            ...
            border: 1px solid rgba(148, 180, 193, 0.5);
        }
        ...
        .stat-card.border-teal { border-color: #0d9488; }
        .stat-card.border-cyan { border-color: #0891b2; }
        .stat-card.border-orange { border-color: #f59e0b; }
        ...
        @media (hover: none) and (pointer: coarse) {
            .menu-item, .btn, button, select, input, textarea {
                min-height: 44px;
            }
            
            .menu-toggle, .notification {
                min-width: 44px;
                min-height: 44px;
            }
        ...
        /* Print Styles */
        @media print {
            .sidebar, .header, .menu-toggle, .notification, 
            .user-profile, .btn, .notification-badge {
    ...
    <div class="dashboard-container">
        ...
        <aside class="sidebar" :class="sidebarOpen || !isMobile ? 'active' : ''">
            ...
            <ul class="sidebar-menu">
                <a href="/mentor/dashboard" class="menu-item active">
                    <i class='bx bx-home-alt'></i>
                    <span class="menu-text">Dashboard</span>
                </a>
                <a href="/mentor/bimbingan" class="menu-item">
                    <i class='bx bx-group'></i>
                    <span class="menu-text">Daftar Bimbingan</span>
                    <span class="menu-badge" id="pesertaCount">0</span>
                </a>
                <a href="/mentor/verifikasi" class="menu-item">
                    <i class='bx bx-check-circle'></i>
                    <span class="menu-text">Verifikasi</span>
                    <span class="menu-badge" id="verifikasiPending">5</span>
                </a>
                <a href="/mentor/penilaian" class="menu-item">
    ...
    <script>
        ...
        window.addEventListener('resize', function() {
            ...
            this.resizeTimer = setTimeout(function() {
                ...
                // Update badge sizes on resize
                updateBadgeSizes();
            }, 250);
        });

        // Update badge sizes based on screen width
        function updateBadgeSizes() {
            const isMobile = window.innerWidth < 768;
            const badges = document.querySelectorAll('.menu-badge, .notification-badge');
        ...
        function updateBadgeCounts() {
            ...
            document.getElementById('logbookPending').textContent = '3';
            document.getElementById('absensiPending').textContent = '2';
        }
