    ...
    <div class="dashboard-container">
        ...
        <aside class="sidebar" :class="sidebarOpen ? 'active' : ''">
            ...
            <ul class="sidebar-menu">
                <a href="/peserta/dashboard" class="menu-item" :class="isActive('/peserta/dashboard') ? 'active' : ''">
                ...
                <a href="/peserta/absensi" class="menu-item" :class="isActive('/peserta/absensi') ? 'active' : ''">
                    <i class='bx bx-calendar-check'></i>
                    <span class="menu-text">Absensi</span>
                </a>
                <a href="/peserta/penilaian-sertifikat" class="menu-item" :class="isActive('/peserta/penilaian-sertifikat') ? 'active' : ''">
            ...
            <header class="header">
                ...
                <div class="header-right">
                    <div class="user-profile" onclick="window.location.href='/peserta/profil'">
                        ...
                        <div class="user-info">
                            <h4 id="userName">{{ Auth::check() ? Auth::user()->name : 'John Doe' }}</h4>
                            <p>Peserta Magang</p>
                        </div>
                    </div>
                </div>
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            if (currentPath === '/' || currentPath === '') {
                const homeItem = document.querySelector('.menu-item[href="/peserta/dashboard"]');
